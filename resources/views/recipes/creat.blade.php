...
<div class="py-12">
    ...
    <label for="body" class="block text-sm font-medium text-gray-700">Zubereitung</label>
      <div class="mt-1">
        <textarea id="body" rows="3" name="steps" class="shadow-sm focus:ring-indigo-500 appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('steps') border-red-400 @enderror"></textarea>
      </div>
      @error('steps')
            <div class="text-sm text-red-400">{{ $message }}</div>
                @enderror
