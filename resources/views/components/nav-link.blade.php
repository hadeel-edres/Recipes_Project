...
$classes = ($active ?? false)
            ...
            : 'inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-white dark:text-gray-400 hover:text-indigo-700 dark:hover:text-gray-300 hover:border-indigo-500 dark:hover:border-gray-700 focus:outline-none focus:text-white dark:focus:text-gray-300 focus:border-white dark:focus:border-gray-700 transition duration-150 ease-in-out';
@endphp
