...
<section class="mt-8 bg-stone-200">
    ...
    <div class="p-5">
        ...
        <a href="{{ route('user.show', ['user_id' => $userrecipe->user_id, 'id' => $userrecipe->id]) }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-indigo-500 rounded-lg hover:indigo-600 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:indigo-500 dark:hover:indigo-600 dark:focus:ring-indigo-500">
            View Rezeptdetails
