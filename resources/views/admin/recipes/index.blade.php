                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <img src="{{ Storage::url($recipe->image) }}" class="w-16 h-16 rounded">
                            </td>
                            <td class="px-6 py-4 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <div class="flex space-x-2">
                                    <a href="{{ route('admin.recipes.edit', $recipe->id) }}"
                                        class="py-2 px-4 bg-green-400 hover:bg-green-600 text-white rounded-lg">Bearbeiten</a>
                                    <a href="{{ route('admin.recipes.show', $recipe->id) }}"
                                        class="py-2 px-4 bg-cyan-500 hover:bg-cyan-700 text-white rounded-lg">Zeigen</a>
                                    <form class="py-2 px-4 bg-red-400 hover:bg-red-600 text-white rounded-lg" method="POST"
                                        ...
                                        onsubmit="return confirm('Bist du sicher?');">
                                        @csrf
                                        @method('DELETE')
