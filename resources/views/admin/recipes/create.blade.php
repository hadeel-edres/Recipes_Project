                    ...
                    <form method="POST" action="{{ route('admin.recipes.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="sm:col-span-6 pt-5">
                         <label for="body" class="block text-sm font-medium text-gray-700">Zutaten</label>
                              <div class="mt-1">
                                <textarea id="body" rows="3" name="ingredients" class="shadow-sm focus:ring-indigo-500 appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('ingredients') border-red-400 @enderror"></textarea>
                                 </div>
                                 @error('ingredients')
                                  <div class="text-sm text-red-400">{{ $message }}</div>
                                  @enderror
