                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div class="mt-1">
                                <textarea id="ingredients" rows="3" name="ingredients"
                                    class="shadow-sm focus:ring-indigo-500 appearance-none bg-white border py-2 px-3 text-base leading-normal transition duration-150 ease-in-out focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('ingredients') border-red-400 @enderror"></textarea>
                            </div>
                            @error('ingredients')
                                <div class="text-sm text-red-400">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div class="mt-1">
                                <textarea id="steps" rows="3" name="steps"
                                    class="shadow-sm focus:ring-indigo-500 appearance-none bg-white border py-2 px-3 text-base leading-normal transition duration-150 ease-in-out focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('steps') border-red-400 @enderror"></textarea>
                            </div>
                            @error('steps')
                                <div class="text-sm text-red-400">{{ $message }}</div>
                            @enderror
