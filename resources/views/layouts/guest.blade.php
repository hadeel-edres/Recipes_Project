...
<head>
    ...
    <title>{{ config('app.name', 'Rec.ipe') }}</title>
    @laravelPWA
    ...
    <div class="bg-stone-300 shadow-md" x-data="{ isOpen: false }">
      <nav class="container px-6 py-8 mx-auto md:flex md:justify-between md:items-center">
        <div class="flex items-center justify-between">
          <a class="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-fuchsia-400 md:text-2xl hover:text-indigo-500"
            href="#">
            Rec.ipe
          </a>
          <!-- Mobile menu button -->
